...
import { Image, TextInput, TouchableWithoutFeedback, TouchableOpacity, View, Text } from "react-native";
      ...
      <View style={[styles.container, this.props.style]}>
        ...
        >
          <View style={styles.code}>
            <Text style={styles.codeTextCountry} numberOfLines={1}>{countryData.name}</Text>
            <Text style={styles.codeText}> (+{countryData.dialCode})</Text>
          </View>
        </TouchableOpacity>
